...
This statement is provided for transparency. It is not a contract and does not create rights or obligations beyond those set out in the [Terms and Conditions](https://remotion.pro/terms) ("**Main Agreement**") and the [Privacy Policy](https://remotion.pro/privacy). A related [DPIA Statement](https://remotion.pro/dpia) explains why the licensing platform and its telemetry are not likely to result in a high risk and why a formal Data Protection Impact Assessment is not required. Where there is any conflict, the Main Agreement and Privacy Policy prevail. This statement is not legal advice.

<div id="Why-No-DPA"></div>

## 1. Why a separate Article 28 DPA is generally not required
...
This does not mean data protection law is irrelevant: GDPR, UK GDPR, and the Swiss nFADP may still apply to Remotion's own controller activities, and Remotion meets those obligations through its [Privacy Policy](https://remotion.pro/privacy) and the practices described below.

<div id="Remotions-Role"></div>

## 2. Remotion's role: Independent Controller
...
The categories of personal data, legal bases, retention, and data subject rights for this processing are described in the [Privacy Policy](https://remotion.pro/privacy).

<div id="What-We-Do-Not-Process"></div>

## 3. What Remotion does not process
...
Telemetry is limited to operational and license metadata that Remotion needs to verify license compliance, support usage-based billing and accountability, and show customers their own rendering activity. As described in the [Telemetry section of the Terms](https://remotion.pro/terms#Telemetry), the information collected is limited to:
...
<div id="Customer-Responsibilities"></div>
...
## 9. Enterprise and custom arrangements
