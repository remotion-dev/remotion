...
export const descriptions: {[key in Pkgs]: string | null} = {
	...
	'browser-bundler': 'Compile virtual Remotion projects in the browser',
	'browser-studio': 'Run Remotion Studio in the browser',
	canvas: 'Experimental primitives for building Remotion authoring interfaces',
	codemods: 'Codemods for Remotion projects',
...
export const apiDocs: {[key in Pkgs]: string | null} = {
	...
	'browser-bundler': 'https://www.remotion.dev/docs/browser-bundler',
	'browser-studio': null,
	canvas: 'https://www.remotion.dev/docs/canvas',
	codemods: 'https://www.remotion.dev/docs/codemods',
	'lambda-client': null,
	'serverless-client': null,
	'studio-server': null,
