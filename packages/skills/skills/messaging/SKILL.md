---
name: messaging
description: Chat and messaging UI patterns for Remotion. Use when creating WhatsApp conversations, iMessage, chat bubbles, text messages, DMs, or messenger-style interfaces.
metadata:
  impact: HIGH
...
- [Chat Messages Example](../example-chat-messages/SKILL.md) - WhatsApp-style bouncy message bubbles
