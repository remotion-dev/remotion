---
name: spring-physics
description: Spring physics animation patterns for Remotion. Use when creating bouncy animations, organic motion, elastic effects, or overshoot animations.
metadata:
  impact: HIGH
...
- [Animated Shapes Example](../example-animated-shapes/SKILL.md) - Bouncing and rotating shapes with spring
- [Morphing Hexagons Example](../example-morphing-hexagons/SKILL.md) - Pulsing hexagon grid with springs
