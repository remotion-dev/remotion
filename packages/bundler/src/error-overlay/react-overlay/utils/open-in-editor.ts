...
const COMMON_EDITORS_OSX: Record<string, string> = {
...
const COMMON_EDITORS_LINUX: Record<string, string> = {
	atom: 'atom',
	Brackets: 'brackets',
	code: 'code',
...
const COMMON_EDITORS_WIN: string[] = [
	'Brackets.exe',
	'Code.exe',
	'Code - Insiders.exe',
	'VSCodium.exe',
		...
		if (process.platform === 'darwin') {
			...
			for (let i = 0; i < processNames.length; i++) {
				...
				if (output.indexOf(processName) !== -1) {
					return [COMMON_EDITORS_OSX[processName] as string];
				}
			}
