...
test('should parse four values', () => {
	...
	expect(result).toEqual({
		topLeft: {horizontal: 100, vertical: 200}, // 100% of width, 100% of height
		topRight: {horizontal: 10, vertical: 10},
...
test('should parse mixed percentages and pixels', () => {
	...
	expect(result).toEqual({
		topLeft: {horizontal: 10, vertical: 10},
		topRight: {horizontal: 150, vertical: 300}, // 150% of width, 150% of height
		bottomRight: {horizontal: 30, vertical: 30},
		bottomLeft: {horizontal: 150, vertical: 300}, // 150% of width, 150% of height
	});
});
...
test('should handle percentages over 100%', () => {
	...
	expect(result).toEqual({
		topLeft: {horizontal: 150, vertical: 300}, // 150% of width, 150% of height
		topRight: {horizontal: 200, vertical: 400}, // 200% of width, 200% of height
		bottomRight: {horizontal: 150, vertical: 300},
		bottomLeft: {horizontal: 200, vertical: 400},
	});
});
