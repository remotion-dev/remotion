...
test('Should get keyframes', async () => {
	...
	expect(keyframes).toEqual([
		...
		},
		{
			...
			presentationTimeInTimescale: 640,
			sizeInBytes: 127982,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 1280,
			sizeInBytes: 204071,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 1920,
			sizeInBytes: 280275,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 2560,
			sizeInBytes: 213213,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 3200,
			sizeInBytes: 250679,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 3840,
			sizeInBytes: 257643,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 4480,
			sizeInBytes: 292951,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 5120,
			sizeInBytes: 307158,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 5761,
			sizeInBytes: 250183,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 6401,
			sizeInBytes: 243845,
			trackId: 1,
		},
		{
			...
			presentationTimeInTimescale: 7041,
			sizeInBytes: 179470,
			trackId: 1,
		},
	]);
