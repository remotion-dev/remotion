...
const appRouterWebhooks = (options: AppRouterWebhookArgs): (req: Request) => Promise<Response> =>  {
...
const headersMutator = (res: NextApiResponse, headers: Record<string, string>) => {
