...
const innerRenderMediaOnCloudrun = async ({
	cloudRunUrl,
	serviceName,
	region,
	serveUrl,
...
export const renderMediaOnCloudrun = RenderInternals.wrapWithErrorHandling(
	innerRenderMediaOnCloudrun
) as typeof innerRenderMediaOnCloudrun;
