...
description: Preview TikTok and Instagram Reels interfaces to keep important content visible.
...
<ElementPage definition={getElementDefinition('overlays/social-safe-zones')} sourceFile="./social-safe-zones.tsx" />
