...
Two [Agent Skills](https://agentskills.io/) define the workflow: scaffold the Element when starting, then submit it when it is ready.
...
Ask your coding agent to use the skill to set up the Element, then implement and review it in Remotion Studio.
...
After reviewing the Element in Remotion Studio, prepare it for review.

### Use the Agent Skill

Use the [`submit-element` Agent Skill](https://github.com/remotion-dev/remotion/blob/main/.agents/skills/submit-element/SKILL.md). It adds the Element to the gallery and prepares it for review.
