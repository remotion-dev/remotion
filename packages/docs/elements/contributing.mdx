...
When ready, [submit the Element](#submit-an-element).

## Submit an Element

Have a small, remixable Remotion Element? We'd like to see it.

Before starting, read the [Element Guidelines](#element-guidelines). They describe the design and quality criteria for Elements.
