...
export const RectEdgeRoundness: React.FC = () => {
  return (
    <table>
      ...
      <tr>
        <td>
          <Rect fill="#0b84f3" debug edgeRoundness={0} height={80} width={80} />
        </td>
        <td>
          <code>0</code> will lead to a rotated rectangle being drawn inside the
          natural dimensions of the rectangle.
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        <td>
          <Rect fill="#0b84f3" debug edgeRoundness={1} height={80} width={80} />
        </td>
        <td>
      ...
      <tr>
        ...
        >
          <Rect fill="#0b84f3" debug edgeRoundness={2} height={80} width={80} />
        </td>
        <td>
          Values below <code>0</code> and above <code>1</code> are possible and
          may result in interesting shapes. Pictured: <code>2</code>
        </td>
      </tr>
    </table>
  );
  ...
  return (
    <table>
      ...
      <tr>
        ...
        <td>
          <code>0</code> will lead to a rotated triangle being drawn inside the
          natural dimensions of the triangle.
        </td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <td>
          <code>1</code> will draw a shape similar to a {'"squircle"'} but as a
          triangle.
        </td>
      </tr>
      <tr>
