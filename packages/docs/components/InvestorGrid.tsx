		...
		<div style={container}>
			...
			<div style={row}>
				...
				<div style={item}>
					...
					<div style={subtitle}>Co-Founder, Nestermind</div>
				</div>
			</div>
			<div style={row}>
				<div style={item}>
				...
				<div style={spacer} />{' '}
				<div style={item}>
					<img style={image} src="/img/investors/vjeux.jpg" />
					<h3 style={title}>Christopher Chedeau</h3>
					<div style={subtitle}>Co-Creator of Excalidraw and React Native</div>
				</div>
				<div style={spacer} />
				<div style={item}>
