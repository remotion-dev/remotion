...
const useStyles = (isDarkTheme: boolean) => ({
	...
	statItem: {
		...
		borderRadius: '0.5rem',
		border: `5px solid ${isDarkTheme ? '#E3E3E3' : '#000000'}`,
		padding: '0.3rem',
...
// TemplatesAndExamples component
const TemplatesAndExamples: React.FC = () => {
	const {isDarkTheme} = useColorMode();
	const styles = useStyles(isDarkTheme);
	return (
		<div
...
const DeveloperCommunityStats4: React.FC = () => {
	...
	return (
		<div style={styles.container}>
			<h2 style={styles.title}>Developer community stats</h2>
			<p style={styles.subtitle}>A thriving community of developers.</p>
