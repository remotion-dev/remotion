...
import styles from './DeveloperCommunityStats5.module.css';
...
const InstallsPerMonth: React.FC = () => {
	...
	return (
		<div className="statItem" style={{width: '32.5%'}}>
			<StatItemContent
				content="100k"
				width="50%"
				fontSize="2.5rem"
...
const DeveloperCommunityStats5: React.FC = () => (
...
export default DeveloperCommunityStats5;
