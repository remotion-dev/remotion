  ...
  return (
    <div className={headerStyles.row}>
      <div style={{ flex: 1 }}>
        ...
        <p>
          The <a href="/showcase">Showcase</a> features videos made with
          Remotion to show use cases, share code and celebrate the creations of
          the Remotion community.
        </p>
        <p>
          You too can add your creations to the showcase! Please read carefully
          the instructions to make it as effortlessly as possible for us to
          accept your video to the showcase.
        </p>
        <h2>Guidelines</h2>
        <ul>
          <li>Metadata:</li>
          <ul>
            ...
            <ul>
              <li>
                Video: A link to where you published your video originally.
              </li>
              <li>
          ...
          <li>
            ...
            repost it on other channels like Twitter and Instagram (we will
            always attribute you).
          </li>
        </ul>
        <h2>How to submit</h2>
        <ol>
