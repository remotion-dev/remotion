export const articles = [
	...
	{
		id: 'studio-codemods/add-solid',
		title: 'addSolid()',
		relativePath: 'docs/studio-codemods/add-solid.mdx',
		compId: 'articles-docs-studio-codemods-add-solid',
		crumb: '@remotion/studio-codemods',
		noAi: false,
		slug: 'studio-codemods/add-solid',
	},
	{
		id: 'studio-codemods/index',
		title: '@remotion/studio-codemods',
		relativePath: 'docs/studio-codemods/index.mdx',
		compId: 'articles-docs-studio-codemods-index',
		crumb: '@remotion/studio-codemods',
		noAi: false,
		slug: 'studio-codemods/index',
	},
	{
