...
<iframe style={{
  width: '100%',
  aspectRatio: '16 / 9'
}} src="https://www.youtube.com/embed/S3C9wlPNhkQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<div>
Discover the new features of Remotion 4.0 in a new video every day. <svg style={{verticalAlign: 'text-bottom', marginLeft: 6}} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M422.6 278.6L445.3 256l-22.6-22.6-144-144L256 66.7 210.8 112l22.6 22.6L322.8 224 32 224 0 224l0 64 32 0 290.7 0-89.4 89.4L210.8 400 256 445.3l22.6-22.6 144-144z"/></svg>
</div>
</a>
...
Edited props in the Remotion Studio can be used to render a video using the Render Button as well - which means you can now render a parametrized video by filling out a form and not having to touch any code.

**Learn more** on July 5th: [Render Button](/4)
...
To demonstrate the possibilities of the new API, we made a new section in the docs entirely dedicated to data-driven videos. See: [Parametrized rendering](/docs/parametrized-rendering).
