...
We start seeing people launching products and startups using Remotion, which is awesome. At the time of writing, five customers are currently in possession of a [Company license](https://companies.remotion.dev).
