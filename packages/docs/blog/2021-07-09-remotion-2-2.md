...
- You can customize how many timeline tracks should be shown at most using `Config.setMaxTimelineTracks()` [#439](https://github.com/remotion-dev/remotion/pull/439)
