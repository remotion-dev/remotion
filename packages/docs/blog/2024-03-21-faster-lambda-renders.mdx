...
With Remotion v4.0.129, [Remotion Lambda](/lambda) renders now complete significantly faster!  
...
Upgrade to Remotion 4.0.129 or later to benefit from the faster rendering on Lambda.  
