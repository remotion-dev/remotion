...
With Remotion v4.0.127, [Remotion Lambda](/lambda) renders now finish significantly faster!
...
Upgrade to Remotion 4.0.127 or later to benefit from the faster rendering on Lambda.  
