...
<sub style={{opacity: 0.5, lineHeight: 1}}>
  Rendering a 1920x1080px video with an <code>&lt;OffthreadVideo&gt;</code> tag loading a 15MB Full HD video and looping it. The Lambda function has been given 3000MB of memory.
</sub>
<br />
<br />
