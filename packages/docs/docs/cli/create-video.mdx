...
- [Agent skills](/docs/ai/skills) are not installed. You can add them manually afterwards by running `npx skills add remotion-dev/skills` in the project directory.
