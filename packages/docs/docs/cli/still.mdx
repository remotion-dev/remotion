...
# npx remotion still<AvailableFrom v="2.3" />
...
To render multiple stills, use [`remotion render` with `--frames`](/docs/cli/render#--frames) instead:<AvailableFrom v="4.0.502" inline />

```bash title="Render frames 0, 30, and 90"
