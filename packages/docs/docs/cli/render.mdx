...
Passing a comma-separated list such as `--frames=0,42,69` outputs only those frames and automatically enables [`--sequence`](#--sequence).<AvailableFrom v="4.0.502" inline />
