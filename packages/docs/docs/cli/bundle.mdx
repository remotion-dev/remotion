...
# npx remotion bundle<AvailableFrom v="4.0.89" />
...
From <AvailableFrom v="4.0.497" inline />, bundles created by this command are relocatable by default. Upload them to Remotion Lambda using [`deploySiteFromBundle()`](/docs/lambda/deploysitefrombundle).
