...
Only for `type="circle"`. Controls how closely curves fit their points. Default: `0.95`.

### `curveTightness?`

Only for `type="circle"`. Controls curve tightness. Default: `0`.

### `curveStepCount?`

Only for `type="circle"`. Controls how many steps are used to approximate curves. Default: `9`.
