...
Visit [remotion.dev/timing-editor](https://www.remotion.dev/timing-editor) to play around with the spring animation parameters and see how they affect the animation.
