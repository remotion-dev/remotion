...
<Step>1</Step> The desire to embed the Studio is usually tied to customizing the
appearance or the behavior of the Studio. It is not currently designed to be
customizable. <br />

<Step>2</Step> The Studio is connected to a backend, it is not a frontend-only
app. <br />
<br />
