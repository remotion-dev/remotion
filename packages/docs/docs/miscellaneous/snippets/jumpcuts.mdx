...
In case of <InlineStep style={{marginLeft: 5}}>3</InlineStep> we are temporarily disabling the [`acceptableTimeshiftInSeconds`](/docs/player/props#acceptabletimeshiftinseconds) prop for force a seek even if it is a tiny jump.
