...
If you want to create live streams programmatically in a React-like fashion, we recommend [Live Compositor](https://compositor.live/) from our friends at [Software Mansion](https://swmansion.com/).
