...
Converts a two-dimensional array of [`Caption`](/docs/captions/captions) items into a string in the SubRip format (`.srt`).
...
An two-dimensional array of [`Caption`](/docs/captions/captions) items.
