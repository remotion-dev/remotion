...
- [`<OffthreadVideo />`](/docs/offthreadvideo) from [`remotion`](/docs/remotion) - a legacy component based on a Rust-based frame extractor
- [`<Html5Video />`](/docs/html5-video) from [`remotion`](/docs/remotion) (previously named `<Video>`) - a legacy component based on the HTML5 `<video>` element
...
| **Supported codecs**                                     | AAC, FLAC, H.264, MP3, Opus, VP8, VP9, Vorbis <br/><br/> Fallback to `<OffthreadVideo>` for unsupported codecs                                         | AAC, AC3, AV1, FLAC, H.264, H.265, M4A, MP3, Opus, PCM, ProRes, VP8, VP9, Vorbis                 | AAC, FLAC, H.264, MP3, Opus, VP8, VP9, Vorbis                                                        |
