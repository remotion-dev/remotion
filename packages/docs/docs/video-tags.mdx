...
| **`toneFrequency`** <br/> (Pitch Change)                 | During preview, server-side rendering, and client-side rendering (from v4.0.523)                                                                       | Only during server-side rendering                                                                | Only during server-side rendering                                                                    |
