...
# &lt;AnimatedEmoji&gt;<AvailableFrom v="4.0.187" />
...
`<AnimatedEmoji>` uses [`<OffthreadVideo>`](/docs/offthreadvideo), which does not support [client-side rendering](/docs/client-side-rendering).
