...
### `trimAfter?`<AvailableFrom v="4.0.530" />
...
See [Timing and trimming](/docs/timing#why-both-trimafter-and-durationinframes) for how `trimAfter` and `durationInFrames` differ.

### `loop?`<AvailableFrom v="4.0.530" />
