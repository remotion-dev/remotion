...
<Step>1</Step> <code>presentation</code>: The effect that is being used, for example
<a href="/docs/transitions/presentations/fade">
  <code>fade()</code>
</a>
or
<a href="/docs/transitions/presentations/wipe">
  <code>wipe()</code>
</a>
.<br />

<Step>2</Step> <code>timing</code>: The duration and the progress curve, for example
<a href="/docs/transitions/timings/springtiming">
  <code>springTiming()</code>
</a>
or
<a href="/docs/transitions/timings/lineartiming">
...
<Step>1</Step> It is forbidden to have a transition that is longer than the duration of the previous or next sequence. <br />
