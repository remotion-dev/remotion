...
A hard editorial cut energized by a short punch-in on both scenes and a restrained flash at the edit point.
...
export const PushCutTransition = () => {
  return (
    <TransitionSeries>
      ...
      >
        <Sequence from={outgoingPunchFrames}>
...
The peak opacity of the flash, from `0` to `1`. Default: `0.1`.
