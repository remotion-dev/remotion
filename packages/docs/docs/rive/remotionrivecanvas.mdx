...
export const MyComp: React.FC = () => {
  ...
  return <RemotionRiveCanvas src="https://example.com/myAnimation.riv" assetLoader={assetLoader} />;
};
```
...
const MyComp: React.FC = () => {
  ...
  return <RemotionRiveCanvas src="https://example.com/myAnimation.riv" ref={canvasRef} />;
};
```
