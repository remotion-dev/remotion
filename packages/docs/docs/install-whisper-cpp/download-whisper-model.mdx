...
<CompatibilityTable chrome={false} firefox={false} safari={false} nodejs bun serverlessFunctions="Writable filesystem required" clientSideRendering="" serverSideRendering="" player="" studio="" hideBrowsers />
