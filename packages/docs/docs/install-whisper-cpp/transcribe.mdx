...
The path to your whisper.cpp folder. If you haven't installed whisper, you can do so for example through [installWhisperCpp()](docs/install-whisper-cpp/install-whisper-cpp).
...
An object containing all the metadata and transcriptions resulting from the transcription process of whisper.
