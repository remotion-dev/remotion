...
Check out [remotion-template-three](https://github.com/jonnyburger/remotion-template-three), a minimal boilerplate for Remotion and React Three Fiber. It is a template repository, you can click "Use this template" on the Github repo to get started.
