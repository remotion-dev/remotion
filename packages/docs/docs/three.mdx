...
Check out [remotion-template-three](https://github.com/remotion-dev/remotion-template-three), a minimal boilerplate for Remotion and React Three Fiber. It is a template repository, you can click "Use this template" on the Github repo to get started.
...
```bash
npm i three @react-three/fiber @remotion/three
```
...
```bash
yarn add three @react-three/fiber @remotion/three
```
