...
See [Custom bundler config](/docs/webpack) for usage and examples.
...
Use [Rspack](/docs/webpack#enable-rspack) instead of Webpack for CLI commands that bundle your project. Default `false`.
