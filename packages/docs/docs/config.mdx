...
Set how many tracks are displayed in the Studio timeline at most. This does not affect your video, only the number of tracks shown while previewing. By default, all tracks are available and the timeline is virtualized.
