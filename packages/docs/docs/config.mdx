...
Overrides the Webpack configuration. It is not called when Rspack is enabled. [See the page about custom bundler configurations](/docs/webpack) for more information.
