...
The bundled FFmpeg binaries are built with GPL components such as x264 and x265. The bundled AAC support uses [`fdk-aac-free`](https://github.com/remotion-dev/rust-ffmpeg-splitter/blob/main/compile-fdkaac.mjs), as shown in the FFmpeg build script. See [FFmpeg license](/docs/miscellaneous/ffmpeg-license) for details.
