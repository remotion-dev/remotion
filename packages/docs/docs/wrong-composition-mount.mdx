...
const MyComp: React.FC = () => {
  return <Composition id="another-comp" width={1080} height={1080} durationInFrames={30} fps={30} component={AnotherComp} />;
};

const Index: React.FC = () => {
  return <Composition id="my-comp" width={1080} height={1080} durationInFrames={30} fps={30} component={MyComp} />;
};
```
...
const MyComp: React.FC = () => {
  return <Composition durationInFrames={300} fps={30} width={1080} height={1080} id="another-component" component={AnotherComp} />;
};

const Index: React.FC = () => {
  return <Player durationInFrames={300} fps={30} compositionWidth={1080} compositionHeight={1080} component={MyComp} />;
};
```
...
const Index: React.FC = () => {
  return <Player durationInFrames={300} fps={30} compositionWidth={1080} compositionHeight={1080} component={AnotherComp} />;
};
```
