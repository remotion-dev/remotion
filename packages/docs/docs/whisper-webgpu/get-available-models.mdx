...
The set of available models may change between versions as faster variants of these models are in development by Hugging Face. If the set of models is changing, we will introduce an API for clearing stale models.
