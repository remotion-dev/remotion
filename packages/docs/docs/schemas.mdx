...
If you want to use this feature, install `zod@3.23.8` and [`@remotion/zod-types`](/docs/zod-types/) for Remotion-specific types:

<Installation pkg="@remotion/zod-types zod@3.23.8" />
