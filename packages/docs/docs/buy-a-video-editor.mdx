...
<img src="https://pub-646d808d9cb240cea53bedc76dd3cd0c.r2.dev/screenshot-framed.png" /> <br />
<br />

This is the editor built by the Remotion team and includes the best practices recommended by us. It features:

- Timeline interface
- Interactive canvas by moving and resizing layers
- Uploading assets to S3
- Captioning with Whisper
- Rendering with Remotion Lambda

More details under: [remotion.pro/editor-starter](https://remotion.pro/editor-starter)
