...
- [Azure Container Apps](/docs/azure-container-apps) <br/>
- [Cloudflare Containers](/docs/cloudflare-containers) <br/>
...
Server-side rendering APIs only send telemetry when the `licenseKey` option is set.  
See [Telemetry](/docs/telemetry) for which information is sent and how to set a license key.
