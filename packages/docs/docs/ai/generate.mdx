...
However, a great starting place is to use Remotion's [System Prompt](/system-prompt.txt) which teaches the general LLM Remotion's APIs and best practices.
...
- [System Prompt](/system-prompt.txt) - A system prompt for teaching LLMs Remotion
