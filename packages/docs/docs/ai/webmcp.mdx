...
- See available compositions and navigate
- Get the current HTML of your composition
- See current outlines of elements and their geometry
- See your current playhead position and playback state
- Play, pause and seek
...
Returns the current playhead, playback, audio, looping and timeline zoom state. Playback fields are `null` when the canvas is not showing a composition.
...
Sets the timeline zoom factor. The requested value is clamped to the range supported by the composition duration. Still compositions do not have timeline zoom.
