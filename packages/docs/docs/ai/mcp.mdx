...
<Step>1</Step> Go to your Cursor Settings: <kbd>Cmd+Ctrl</kbd> + <kbd>P</kbd>,
then type `> Cursor Settings` and confirm with Enter.
...
<img
	style={{width: 600}}
	src="https://pub-646d808d9cb240cea53bedc76dd3cd0c.r2.dev/mcp-cursor.png"
/>
