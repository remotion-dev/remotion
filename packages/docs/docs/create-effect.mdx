...
Defining an effect does not require a browser. Applying it requires a canvas component and support for the selected `2d`, `webgl2` or `webgpu` backend. See [Using WebGL and WebGPU during renders](/docs/webgl).
