...
`whiteNoise()` blends the source towards a random grayscale image. By default, it fully replaces visible pixels with white noise. This makes it suitable for strong static and signal-loss looks.
