...
# `wave()`<AvailableFrom v="4.0.464" />

Applies a sine wave warp to a canvas-backed component using WebGL2. The image is displaced smoothly along the wave axis (no slice gaps).
