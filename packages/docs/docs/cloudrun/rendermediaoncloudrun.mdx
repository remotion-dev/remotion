...
An object containing additional information about the video output. This can include properties such as Author, comment, and other relevant data to provide context and enhance the video’s usability.
