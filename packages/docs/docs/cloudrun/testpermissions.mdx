...
<CompatibilityTable chrome={false} firefox={false} safari={false} nodejs bun serverlessFunctions="Package files required" clientSideRendering="" serverSideRendering="" player="" studio="" hideBrowsers />

The Cloud Run package files must be included in the serverless deployment.
