...
<Step>2</Step> the renderer does not
<strong>wait for data or assets to be loaded</strong>.
...
<Step>1</Step> A component should always display the same visual when called
multiple times.
<br />
...
function.
<br />
<Step>3</Step> Ensure you correctly wait
<a href="/docs/fonts">for fonts to load</a>.<br />
