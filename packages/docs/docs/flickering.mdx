...
<Step>2</Step> the renderer does not <strong>
  wait for data or assets to be loaded
</strong>
.
...
<br />
<Step>3</Step> Ensure you correctly wait <a href="/docs/fonts">
  for fonts to load
</a>
.<br />
<Step>4</Step> Only call <a href="/docs/layout-utils/fit-text">
  <code>fitText()</code>
</a>, <a href="/docs/layout-utils/fill-text-box">
