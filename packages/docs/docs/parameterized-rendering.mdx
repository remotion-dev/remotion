...
import {TableOfContents} from './parameterized-rendering/TableOfContents';

![Editing default props in Remotion Studio](/img/parameterized-rendering-default-props.png)
...
<li>
A schema may optionally be defined to validate the data and customize the visual controls.
</li>
<li>
In absence of data, default props can be edited in the Remotion Studio. [Basic controls are inferred from their values](/docs/default-props-inference).
</li>
</ul>
