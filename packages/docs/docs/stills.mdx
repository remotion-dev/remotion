...
You can use the [`renderStillOnWeb()`](/docs/renderer/render-still-on-web) browser API to render a still frame programmatically.
...
You can use [Cloud Run](/cloudrun) to render stills:
