---
image: /generated/articles-docs-videos-accelerated-video.png
...
:::note
We are [disabling the media fragment hints](/docs/videos/media-fragments) being appended to the video URL by adding `#disable` to the end of the URL.
:::
...
- [Different segments at different speeds](/docs/videos/different-segments-at-different-speeds)
