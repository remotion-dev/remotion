---
image: /generated/articles-docs-videos-media-fragments.png
...
For [`<Video>`](/docs/media/video) and [`<Audio>`](/docs/media/audio), this does not apply.
...
Normally you would not do this, but there are exceptions, like: [Changing the speed of a video over time](/docs/videos/accelerated-video)
