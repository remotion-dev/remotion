...
It has all the drawbacks of the [`<Html5Video>`](/docs/videos/video-tags) tag and is therefore **deprecated** in favor of using the recommended approach mentioned above.
