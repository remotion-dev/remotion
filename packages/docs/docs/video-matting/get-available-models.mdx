...
The [`modnet` model](https://huggingface.co/Xenova/modnet) is Apache-2.0 licensed.  
The [`ben2-base` model](https://huggingface.co/onnx-community/BEN2-ONNX) is the MIT-licensed BEN2 Base export.

## Model hosting

The `modelId` values identify the upstream Hugging Face models.  
