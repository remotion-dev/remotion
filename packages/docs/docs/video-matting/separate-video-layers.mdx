...
The downloaded model is loaded automatically if needed. Call [`downloadVideoMattingModel()`](/docs/video-matting/download-video-matting-model) first to cache the model files.
