---
image: /generated/articles-docs-client-side-rendering-page-responsiveness.png
...
The default favors an interactive page.
...
When rendering with the Web Renderer in Remotion Studio, the render modal exposes a <kbd>Page Responsiveness</kbd> setting in the <kbd>Other</kbd> tab.
The default is <kbd>Medium</kbd>.
