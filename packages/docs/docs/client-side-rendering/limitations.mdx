...
Inline `<svg>` elements are <a style={{color: 'green'}}>supported</a>. URL paint servers, such as gradient fills and strokes, are preserved during rasterization from <AvailableFrom v="4.0.515" inline />.<br />
