...
:::info
If automatic [HTML-in-canvas capture](/docs/client-side-rendering/html-in-canvas) is active, these CSS limitations don't apply because a full screenshot is taken instead.
:::
