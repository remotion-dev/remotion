...
By default, [`renderMediaOnWeb()`](/docs/web-renderer/render-media-on-web) prioritizes render speed.
Pass [`pageResponsiveness`](/docs/web-renderer/render-media-on-web#pageresponsiveness) to intentionally pause between frames and keep the page more responsive.
