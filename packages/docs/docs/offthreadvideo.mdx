...
:::note Deprecated
This prop is deprecated in favor of [`trimBefore`](#trimbefore). It will continue to work but you cannot use it together with the new prop.
:::
...
:::note Deprecated
This prop is deprecated in favor of [`trimAfter`](#trimafter). It will continue to work but you cannot use it together with the new prop.
:::
