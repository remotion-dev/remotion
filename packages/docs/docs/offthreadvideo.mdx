...
:::note
On iOS Safari, it's currently not possible to granularly change the volume of a media tag.  
Before Remotion v4.0.279, the maximum value was 1.
Since v4.0.279, the Web Audio API will be used to synthetically amplify audio that has a volume higher than 1.
:::
