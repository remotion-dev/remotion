...
This component was designed to combat limitations of the `<Html5Video>` element. See: [Comparison of video tags](/docs/videos/video-tags).
...
Consider using [another video tag](/docs/videos/video-tags) for looping.
