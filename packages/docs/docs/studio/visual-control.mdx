...
<CompatibilityTable chrome firefox safari nodejs="" bun="" serverlessFunctions="" clientSideRendering="Original value outside Studio" serverSideRendering="Returns the original value" player="Returns the original value" studio="Editable Studio" hideServers />
