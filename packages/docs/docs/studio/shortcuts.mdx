...
| `splitSequences`                | `Cmd/Ctrl+Shift+D`                         | Split eligible selected sequences at the playhead <AvailableFrom v="4.0.527" inline /> |
...
| `pickColor`                     | `Shift+C`                                  | Open the color picker <AvailableFrom v="4.0.525" inline />                             |
