...
# Deploy Remotion Studio as static site<AvailableFrom v="4.0.97" />
...
:::note
Before Remotion v4.0.497, pass `--public-path="./"`. Upgrade to v4.0.497 or newer if the bundle uses files from the `public/` directory at a nested URL.
:::
