...
<Step>3</Step> Go to the settings of your repository
(github.com/[username]/[repo]/settings/pages) <br />

<Step>4</Step> In the Branch section, select the <code>gh-pages</code> branch
and click save.
