---
image: /generated/articles-docs-studio-protocol-build-open-in-remotio-new-url.png
title: 'buildOpenInRemotioNewUrl()'
crumb: '@remotion/studio-protocol'
---

# buildOpenInRemotioNewUrl()<AvailableFrom v="4.0.526" />
...
export const OpenInRemotion = () => {
  return (
    <a
      href={buildOpenInRemotioNewUrl({payload})}
      target="_blank"
