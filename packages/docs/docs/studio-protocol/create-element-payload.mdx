...
Creates a validated, versioned Element payload for [`buildOpenInRemotioNewUrl()`](/docs/studio-protocol/build-open-in-remotio-new-url), [`setStudioDragData()`](/docs/studio-protocol/set-studio-drag-data), and [`installInStudio()`](/docs/studio-protocol/install-in-studio).
...
- [`buildOpenInRemotioNewUrl()`](/docs/studio-protocol/build-open-in-remotio-new-url)
