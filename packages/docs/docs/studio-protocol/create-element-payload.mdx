...
Creates a validated, versioned Element payload for [`buildOpenInRemotionDotNewUrl()`](/docs/studio-protocol/build-open-in-remotion-dot-new-url), [`setStudioDragData()`](/docs/studio-protocol/set-studio-drag-data), and [`installInStudio()`](/docs/studio-protocol/install-in-studio).
...
- [`buildOpenInRemotionDotNewUrl()`](/docs/studio-protocol/build-open-in-remotion-dot-new-url)
