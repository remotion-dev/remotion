...
**For [`@remotion/webcodecs`](/docs/webcodecs)** (_deprecated_): Telemetry is enabled by default, but Remotion will not enforce the license for this deprecated package.
