...
```tsx twoslash
import {DownloadWhisperModelOnProgress, DownloadWhisperModelProgress} from '@remotion/whisper-wasm';
...
- [Source code for this function](https://github.com/remotion-dev/remotion/blob/main/packages/whisper-wasm/src/download-whisper-model.ts)
