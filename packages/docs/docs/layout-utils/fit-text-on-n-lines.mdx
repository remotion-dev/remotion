...
\_Part of the [`@remotion/layout-utils`](/docs/layout-utils) package. Available from v4.0.312

Calculates the `font-size` needed to fit a text into a given width while respecting a maximum number of lines.
