...
```ts twoslash title="get-audio-data.ts"
import {getAudioData} from '@remotion/media-utils';
import {staticFile} from 'remotion';

await getAudioData(staticFile('music.mp3')); /* {
...
<CompatibilityTable chrome="Supported codecs" firefox="Supported codecs" safari="Supported codecs" nodejs="" bun="" serverlessFunctions="" clientSideRendering serverSideRendering player studio hideServers />

Supported media formats depend on the browser. During server-side rendering, this API runs inside Chromium.
