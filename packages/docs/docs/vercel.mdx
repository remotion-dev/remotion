...
- [Next.js - Example Render endpoint](https://github.com/remotion-dev/remotion/blob/main/packages/template-next-app-tailwind/src/app/api/lambda/render/route.ts)
- [Next.js - Example Progress endpoint](https://github.com/remotion-dev/remotion/blob/main/packages/template-next-app-tailwind/src/app/api/lambda/progress/route.ts)
