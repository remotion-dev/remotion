...
<Step>1</Step> Remotion uses
<a href="https://pnpm.io/">
  <code>pnpm</code> v10.17.1
</a>
as the package manager for development in this repository. We recommend using Corepack so you get the same version of pnpm as we have. <br />

```sh
corepack enable
```

If you don't have `corepack`, install `pnpm@10.17.1` manually:
