...
<Step>2</Step> Run <code>node new-doc.mjs</code> and follow the instructions.
<br />
...
<br />
<Step>5</Step> Run <code>node render-cards.mjs</code> in <code>packages/docs</code> to generate preview cards that will show up if the documentation page is shared on social media.
<br />
