...
Give it the same name as the ID of the composition your want to record for.  
...
If you want to not use a take, just make another recording. The `copy.ts` script will only take the recordings with the biggest timestamp.
