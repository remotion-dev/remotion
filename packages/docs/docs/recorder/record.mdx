...
To delete a recording, simply delete locate the file in your public folder and delete them.  
The Remotion Studio will automatically refresh move all other recordings to the next available number.
