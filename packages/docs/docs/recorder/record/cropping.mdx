...
<Step>1</Step> Download <a href="https://obsproject.com/">OBS from their website</a> and install it.
<br />

<Step>2</Step> Open OBS and click on <kbd>Settings</kbd> -> <kbd>Video</kbd>. Set as both the "Base Resolution" and Canvas Resolution the resolution of your desired output. We recommend 1920x1080. Click on <kbd>OK</kbd>.
<br />
...
<Step>6</Step> In the Remotion <a href="/docs/recorder/record/">Recording interface</a>, you can now select "OBS Virtual Camera" as the source.
