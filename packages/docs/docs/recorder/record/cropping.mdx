...
<Step>1</Step> Download
<a href="https://obsproject.com/">OBS from their website</a> and install it.
<br />
...
<Step>6</Step> In the Remotion
<a href="/docs/recorder/record/">Recording interface</a>, you can now select
"OBS Virtual Camera" as the source.
