...
Recordings need to be stored in a subfolder of `public` named after the composition ID.
...
Use the ID of the composition you want to record for as the folder name.
