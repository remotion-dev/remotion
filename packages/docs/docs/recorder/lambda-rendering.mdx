...
await $`bunx remotion lambda render ${siteName} ${compositionId} --props='{"canvasLayout": "square", "platform": "linkedin"}'`;
await $`bunx remotion lambda render ${siteName} ${compositionId} --props='{"canvasLayout": "square", "platform": "x"}'`;
await $`bunx remotion lambda render ${siteName} ${compositionId} --props='{"canvasLayout": "landscape", "platform": "youtube"}'`;
```
