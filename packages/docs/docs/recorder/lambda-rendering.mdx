...
First you need to set up Remotion Lambda. Follow the instructions shown [here](/docs/lambda/setup) from step 1 to and including step 7.

## Deploy and render

We recommend to add the following function and site deployment as well the render command into a shell script you can execute each time you want to render a video:
...
For exmaple if you would want to render your video for YouTube, X, and Instagram, your shell script could look like this:
