...
In the default props editor in the right sidebar, you may choosea value for `music` for each scene:
...
```tsx filename="remotion/config/sounds.ts"
...
import { TimelineTracks } from "../../../../studio/src/components/Timeline/TimelineTracks"
