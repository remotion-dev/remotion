...
The goal of the Recorder: Make it easy and fast to <strong>edit once and export for different platforms</strong>.
...
Add captions so you capture a viewers interest before they scroll by.
