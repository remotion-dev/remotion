...
This obligation does not apply to companies under the "Remotion for Creators" option. Creators may still set a `licenseKey` to track their own usage, but it is not required.
