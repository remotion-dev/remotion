...
Use them with [`Interactive.withSchema()`](/docs/with-interactivity-schema).
...
See [`Interactive.withSchema()`](/docs/with-interactivity-schema).
...
Every `Interactive` component inherits [`durationInFrames`](/docs/sequence#durationinframes), [`from`](/docs/sequence#from), [`freeze`](/docs/sequence#freeze), [`hidden`](/docs/sequence#hidden), [`name`](/docs/sequence#name) and [`showInTimeline`](/docs/sequence#showintimeline) from [`<Sequence>`](/docs/sequence).
