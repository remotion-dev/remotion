...
`Interactive` elements require a Remotion composition or [`<Player>`](/docs/player). They throw an error in a regular React tree. Use native HTML or SVG elements outside Remotion.
