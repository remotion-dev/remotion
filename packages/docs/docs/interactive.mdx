...
Wraps a component that accepts Remotion's [`Caption[]`](/docs/captions/caption) format and exposes its text, timings and container layout to the Studio editor.

See [`Interactive.withCaptions()`](/docs/interactive-with-captions).
...
- [`Interactive.withCaptions()`](/docs/interactive-with-captions)
