...
:::note
AC-3 and E-AC-3 are not natively supported by WebCodecs.
Remotion registers a software decoder from [`@mediabunny/ac3`](https://www.npmjs.com/package/@mediabunny/ac3) to enable decoding of these codecs.
:::
