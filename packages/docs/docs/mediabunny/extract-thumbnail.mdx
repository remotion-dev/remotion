...
The function returns a [`VideoSample`](https://mediabunny.dev/api/VideoSample#videosample) object. When it gets cleaned pup by garabge collection, it will be automatically closed, but a warning will be printed.
