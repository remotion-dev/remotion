...
Apple ProRes decoding can be enabled from <AvailableFrom v="4.0.487" inline /> using `@mediabunny/prores`. See [ProRes - Using ProRes with `@remotion/media`](/docs/prores#using-prores-with-remotionmedia).
