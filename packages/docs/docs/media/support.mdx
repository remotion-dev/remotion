...
Apple ProRes decoding can be enabled from <AvailableFrom v="4.0.485" inline /> using `@mediabunny/prores`. See [Supported formats and codecs by Mediabunny](/docs/mediabunny/formats#prores).
