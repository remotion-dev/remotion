...
<ul>
  <li>
    <strong>In the Next.js Pages Dir template:</strong> Under <code>pages/index.tsx</code>.
  </li>
  <li>
    <strong>In the Next.js App Dir template:</strong> Under <code>app/page.tsx</code>.
  </li>
  <li>
    <strong>In the React Router template:</strong> Under <code>app/home.tsx</code>.
  </li>
</ul>
