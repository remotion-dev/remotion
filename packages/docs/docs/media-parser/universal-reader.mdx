...
It is the combination of [`nodeReader`](/docs/media-parser/node-reader), [`fetchReader`](/docs/media-parser/fetch-reader) and [`webFileReader`](/docs/media-parser/web-file-reader) altogether.
