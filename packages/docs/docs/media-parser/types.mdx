...
```tsx twoslash
import type {MediaParserDetailedColor} from '@remotion/media-parser';
//                ^?
```
...
```tsx twoslash
import {MediaParserVideoCodec, MediaParserCodecData, MediaParserSampleAspectRatio, MediaParserDetailedColor} from '@remotion/media-parser';
