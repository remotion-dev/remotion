...
<CompatibilityTable chrome={false} firefox={false} safari={false} nodejs bun serverlessFunctions="Local bundle required" clientSideRendering="" serverSideRendering="" player="" studio="" hideBrowsers />

The bundle directory must be available in the filesystem of the calling server or serverless function.
