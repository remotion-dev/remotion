---
image: /generated/articles-docs-studio-codemods-index.png
sidebar_label: Overview
title: '@remotion/studio-codemods'
crumb: '@remotion/studio-codemods'
---

# @remotion/studio-codemods<AvailableFrom v="4.0.527" />
...
<Installation pkg="@remotion/studio-codemods" />
...
import type {CodemodProject} from '@remotion/studio-codemods';
