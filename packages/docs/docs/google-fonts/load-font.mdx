...
If your project uses multiple fonts, load them in one module and export a `waitForFonts()` helper. If you measure text, gate rendering until the fonts are loaded using a higher-order component:
