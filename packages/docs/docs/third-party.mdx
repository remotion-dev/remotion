...
There is no integration available, but there is an example of how you can "bake" the Matter.js into a timeline in order to synchronize it later with Remotion.

See an example [here](https://github.com/orgs/remotion-dev/discussions/4373) and join the discussion.
