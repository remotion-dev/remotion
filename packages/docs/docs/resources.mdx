...
- [Faceless Shorts Kit — Faceless shorts pipeline: premise-scoring engine + typed content schemas + 6 render templates](https://shortkit.gumroad.com/l/faceless-shorts-kit)
...
- Greenscreen Effect ([Docs](/docs/videos/video-manipulation))
...
- MapLibre example ([Source code](https://github.com/remotion-dev/maplibre-example))
...
- [Remocn](https://remocn.dev) - Adjustable production-ready components for Remotion ([Source code](https://github.com/kapishdima/remocn))
- [React Video Editor](https://www.reactvideoeditor.com/remotion-templates?utm_source=remotion) - A collection of free and ready-to-use Remotion templates ([Source Code](https://github.com/reactvideoeditor/remotion-templates))
...
- [Remotion Bits](https://remotion-bits.dev/) - Collection of animation components and utilities designed specifically for Remotion video projects. ([Source code](https://github.com/av/remotion-bits))
...
- TikTok Text Box - React component that mimics the TikTok text box style ([Source Code](https://github.com/KyleTryon/TikTokTextBox))
- [snapcn](https://snapcn.dev) - Video components that look like software, for Remotion ([Source code](https://github.com/snapcndev/snapcn))
...
- [Use GSAP timelines in Remotion](/docs/gsap)
...
- [Animatiq - AI motion design and video creation tool](https://animatiq.ai)
- [shortshort - Turns a long video into vertical shorts with word-by-word captions](https://www.shortshort.io)
