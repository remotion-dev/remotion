      ...
      calculateMetadata={async ({props}) => {
        ...
        return {
          durationInFrames: Math.floor(
            durationInSeconds * compositionFps,
          ),
          fps: compositionFps,
        };
      }}
...
export const Index: React.FC = () => {
  ...
  useEffect(() => {
    getMediaMetadata('https://remotion.media/video.mp4')
      .then(({durationInSeconds, fps}) => {
        const compositionFps = fps ?? 30;
        setMetadata({
          durationInFrames: Math.round(durationInSeconds * compositionFps),
          fps: compositionFps,
        });
  ...
  return <Composition id="dynamic-duration" component={VideoTesting} width={1080} height={1080} fps={metadata.fps} durationInFrames={metadata.durationInFrames} />;
};
```
...
export const Index: React.FC = () => {
  ...
  return <Player component={VideoTesting} compositionWidth={1080} compositionHeight={1080} fps={metadata.fps} durationInFrames={metadata.durationInFrames} />;
};
```
