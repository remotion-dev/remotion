...
<CompatibilityTable chrome="Supported codecs" firefox="Supported codecs" safari="Supported codecs" nodejs="" bun="" serverlessFunctions="" clientSideRendering="Supported codecs" serverSideRendering="Supported codecs" player="Supported codecs" studio="Supported codecs" hideServers />

Audio decoding depends on [Mediabunny format support](/docs/mediabunny/formats) and the codecs available in the browser. During server-side rendering, this hook runs inside Chromium.
