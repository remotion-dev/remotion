...
_Available from v4.397 - Part of the `@remotion/web-renderer` package._
...
See [Cancelling renders](/docs/web-renderer/cancellation) for more details and error handling patterns.
