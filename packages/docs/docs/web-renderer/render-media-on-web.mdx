...
If you want to render a single frame to an image, use [`renderStillOnWeb()`](/docs/client-side-rendering/render-still-on-web).
...
_number | [number, number]_ <TsType type="FrameRange" source="@remotion/web-renderer" />
