...
# getCanExtractFramesFast()<AvailableFrom v="3.3.2" />
...
_Removed in v4.0 - Part of the `@remotion/renderer` package._
...
<CompatibilityTable chrome={false} firefox={false} safari={false} nodejs="Remotion 3" bun="Not verified" serverlessFunctions={false} clientSideRendering="" serverSideRendering="Remotion 3" player="" studio="" hideBrowsers />

This table describes the historical API. It was removed in Remotion 4.0.
