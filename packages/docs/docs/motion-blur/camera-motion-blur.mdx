...
# &lt;CameraMotionBlur&gt;<AvailableFrom v="3.2.39" />
...
The default [client-side renderer](/docs/client-side-rendering/limitations#unsupported-styles) does not support the `mix-blend-mode` used by this component. Use [HTML-in-canvas capture](/docs/client-side-rendering/html-in-canvas) to render it client-side.
