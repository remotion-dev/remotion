...
<br/><Step>2</Step> want to transform the props passed to the composition, for example
to do <a href="/docs/data-fetching">data fetching</a>
<br/><Step>3</Step> want to add a per-composition default codec
<br/><Step>4</Step> want to run code once, before the actual render starts.
