...
Nesting [`<HtmlInCanvas>`](/docs/remotion/html-in-canvas) components requires Chrome or Chromium `152.0.7944.0` or later.
...
Not directly related, but [`@remotion/web-renderer`](/docs/client-side-rendering/html-in-canvas) also uses this technology to capture frames.
