...
This mode can render compositions that contain [`<HtmlInCanvas>`](/docs/remotion/html-in-canvas) elements from <AvailableFrom v="4.0.461" inline /> because nested HTML-in-canvas captures are handled using an auxiliary canvas.
