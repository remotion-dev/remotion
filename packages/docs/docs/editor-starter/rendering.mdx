...
sidebar_label: Lambda rendering
id: rendering
crumb: Editor Starter
---

By default, videos are rendered using [Remotion Lambda](/docs/lambda), a distributed renderer on AWS Lambda.

You can instead enable [client-side rendering](/docs/editor-starter/client-side-rendering) to render videos in the user's browser without Remotion Lambda.
...
When no item is selected in the Editor Starter, a Render button shows up in the [inspector](/docs/editor-starter/tracks-items-assets#inspectors) (i.e., composition inspector).
...
- [Client-side rendering](/docs/editor-starter/client-side-rendering)
