...
If the user drops in any image, audio, video or GIF, they are uploaded to cloud storage so that they remain accessible during editing and rendering.
...
- Go to [IAM -> "Users"](https://us-east-1.console.aws.amazon.com/iam/home?region=us-east-1#/users) in the AWS console.
  - **If you have already set up [Lambda rendering](/docs/editor-starter/rendering)**: Select the user you created.
...
:::note
The same environment variables are also used for [Lambda rendering](/docs/editor-starter/rendering).
:::
