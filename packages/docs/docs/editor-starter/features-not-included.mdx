...
Make sure to protect the backend endpoints you enable. The template does not add authentication or rate limits to asset uploading, captioning, or Lambda rendering endpoints.
