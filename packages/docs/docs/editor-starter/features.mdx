...
Shows information about the associated [asset](/docs/editor-starter/tracks-items-assets#assets) of this item, such as the file name and size, and [upload progress](/docs/editor-starter/asset-uploads) and [download progress](/docs/editor-starter/persistance) of the asset.
