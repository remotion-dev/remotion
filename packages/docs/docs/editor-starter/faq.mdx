...
Especially if the feature is listed in the [Features not included](/docs/editor-starter/features-not-included) section.

That being said, we do plan to maintain and enhance the Editor Starter.
