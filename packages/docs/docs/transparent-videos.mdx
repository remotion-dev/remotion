...
## Creating a WebM with Alpha channel
...
## Creating a ProRes with Alpha channels

If you want to export a transparent video for use in another video editing program, and you are using macOS, ProRes is a more suitable option.

Supported since v2.1.6, you can set the codec to `prores` and choose a ProRes profile with alpha support: Either: `4444` or `4444-hq`.
