...
A link to the CloudWatch logs of the renderer functions, if you have not disabled CloudWatch.

### `cloudWatchMainLogs`<AvailableFrom v="4.0.174" />

A link to the CloudWatch logs of the main function.
...
<CompatibilityTable chrome={false} firefox={false} safari={false} nodejs bun serverlessFunctions="Node.js runtime" clientSideRendering="" serverSideRendering player="" studio="" hideBrowsers />

For serverless functions, use the [light client](/docs/lambda/light-client).
