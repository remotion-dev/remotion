...
</a> - either directly or via the CLI which also calls this API. This invocation is called the <strong>main function</strong>.<br />
...
</a> API queries the S3 bucket for the <code>progress.json</code> file and returns the progress of the render.
<br />
