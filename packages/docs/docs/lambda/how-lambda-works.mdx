...
is called the <strong>main function</strong>.
<br />
...
</a> API queries the S3 bucket for the <code>progress.json</code> file and returns
...
<sup>1)</sup> An API for avoiding the S3 bandwidth charge is <a href="https://github.com/remotion-dev/remotion/issues/3817">
  planned
</a>
.
