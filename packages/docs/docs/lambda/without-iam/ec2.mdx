...
<Step>1</Step>From the application directory, create a file named <code>.env</code>
<br />
<Step>2</Step> Assign values for the environment keys such as <code>PORT</code>, <code>REMOTION_ROLE_ARN</code>, <code>REMOTION_ROLE_SESSION_NAME</code>, <code>API_USERNAME</code>, <code>API_PASSWORD</code>
<br />
<br />
