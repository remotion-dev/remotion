...
- If you add a filename to the end of the render command `npx remotion lambda render [url] [composition-id] out.mp4`, the video will be downloaded to your computer!
