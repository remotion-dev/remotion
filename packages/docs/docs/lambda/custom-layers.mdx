...
You are responsible for keeping custom Layers compatible with Remotion and granting access to their ARNs. When custom Layers are omitted, Remotion continues to use its hosted Layers.
