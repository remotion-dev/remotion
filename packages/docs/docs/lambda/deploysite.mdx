...
If the project was already bundled in an earlier build step, use [`deploySiteFromBundle()`](/docs/lambda/deploysitefrombundle) to upload it without bundling again.
