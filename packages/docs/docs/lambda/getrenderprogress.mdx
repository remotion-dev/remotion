...
- `frameRange`: The selected frame range, or an array of ranges when rendering multiple sections.<AvailableFrom v="4.0.502" inline />
- `chunkRanges`: The source frame range assigned to each Lambda chunk.<AvailableFrom v="4.0.502" inline />
