...
From <AvailableFrom v="4.0.517" inline />, you can set `concurrency` to `1` to render the video on the main function. A progress request may briefly use another invocation.
