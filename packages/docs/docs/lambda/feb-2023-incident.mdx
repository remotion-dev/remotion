...
<Step>2</Step> change your policies to give your user the <code>lambda:PutRuntimeManagementConfig</code> permission. The easiest way is to copy the following user policy: <br />
<br />

<details>
  <summary>Show full user permissions JSON file for latest Remotion Lambda version</summary>
  <UserPolicy />
</details>
...
<Step>1</Step> Go to the function in the AWS dashboard and click "Edit Runtime management configuration".
<br />
<br />
