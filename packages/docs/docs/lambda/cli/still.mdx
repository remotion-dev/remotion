...
A JSON string matching [`s3OutputProvider`](/docs/lambda/custom-destination#saving-to-another-cloud). Use it to save the rendered still to an S3-compatible provider such as Cloudflare R2.
