...
## `--custom-layer-arns`<AvailableFrom v="4.0.510" />
...
See [Custom Layers](/docs/lambda/custom-layers). This flag is required in [AWS China regions](/docs/lambda/aws-china-regions).
