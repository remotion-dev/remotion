---
image: /generated/articles-docs-lambda-pagerouterwebhooks.png
...
Simplifies the process of setting up Remotion Lambda Client in your Next.js app which is using Pages Router. Similar to [appRouterWebhooks()](/docs/lambda/approuterwebhooks).
