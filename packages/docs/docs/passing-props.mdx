...
You can use [Zod](https://github.com/colinhacks/zod) to [define a typesafe schema for your composition](/docs/schemas). A schema is not required for visual editing. Add one when you need validation, constraints, choices or specialized controls.
