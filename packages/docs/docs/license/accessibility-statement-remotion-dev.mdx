...
- **Color contrast.** Our brand blue (`#0B84F3`) does not meet the 4.5:1 contrast ratio against white required by WCAG 1.4.3. Several other elements (search placeholder, "Ask AI" button, sidebar tags, chart labels) also fall short. A site-wide contrast pass is planned.
