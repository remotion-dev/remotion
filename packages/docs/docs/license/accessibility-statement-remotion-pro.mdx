...
This page is a one-time copy of the accessibility statement published on [remotion.pro](https://www.remotion.pro/accessibility), made so that it is discoverable alongside our other accessibility documentation. It is not kept in sync automatically - refer to [remotion.pro/accessibility](https://www.remotion.pro/accessibility) for the current, canonical version.
:::
