...
:::warning
Unstable API: This package is experimental for the moment. It remains supported and is not deprecated. For new browser transcription integrations, prefer [`@remotion/whisper-webgpu`](/docs/whisper-webgpu), which uses WebGPU when available and does not require cross-origin isolation.
:::
