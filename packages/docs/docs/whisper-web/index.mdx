...
:::warning
Unstable API: This package is experimental and might not become stable. Prefer [`@remotion/whisper-webgpu`](/docs/whisper-webgpu), which uses WebGPU and does not require cross-origin isolation.
:::
