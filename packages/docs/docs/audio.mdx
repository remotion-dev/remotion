...
:::note Deprecated
These props are deprecated in favor of [`trimBefore`](#trimbefore--trimafter) and [`trimAfter`](#trimbefore--trimafter). They will continue to work but you cannot use them together with the new props.
:::
