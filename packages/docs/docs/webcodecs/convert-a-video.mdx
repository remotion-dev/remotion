...
You can convert a video in the browser from one format to another using the [`convertMedia()`](/docs/convert-media) function from [`@remotion/webcodecs`](/docs/webcodecs).
...
- [`convertMedia()`](/docs/convert-media)
