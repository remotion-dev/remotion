...
If you supply a rotation, it will be in addition to the automatic rotation correction that [`convertMedia()`](/docs/convert-media) applies by default.
...
The rotations will negate each other, and [`convertMedia()`](/docs/convert-media) will not execute any code to apply rotation.
