...
For using Whisper, Whisper.cpp, [`@remotion/install-whisper-cpp`](/docs/webcodecs/install-whisper-cpp) and Whisper.wasm, you need to provide a 16-bit, 16KHz, WAVE audio file.
