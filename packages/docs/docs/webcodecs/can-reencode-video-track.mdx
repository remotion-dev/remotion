...
This capability check can run without WebCodecs. It reports whether the current runtime can decode and encode the requested track; supported codecs vary by browser and operating system.
