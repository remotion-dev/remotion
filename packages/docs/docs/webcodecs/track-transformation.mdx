...
To check outside of a `onVideoTrack` handler, you can also use the [`canCopyVideoTrack()`](/docs/webcodecs/can-copy-video-track) and [`canCopyAudioTrack()`](/docs/webcodecs/can-copy-audio-track) APIs
