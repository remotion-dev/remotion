...
- `--browser-executable`: [to add custom chrome executable](config#setbrowserexecutable). If you add custom chrome executable it will help rendering H.264 video (MP4).
