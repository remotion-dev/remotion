...
Note that Remotion does not consider a volume of 0 "muted".  
Adapt the logic to also listen to the [`volumechange`](/docs/player/player#volumechange) event if necessary.
