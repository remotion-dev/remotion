...
:::note
Remotion and your React app use a different Webpack config. Therefore, if you want to override your [Webpack configuration](/docs/bundlers), you need to override both the Remotion one and the React app one.
:::
