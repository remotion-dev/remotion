...
export const App: React.FC = () => {
  return <Player component={MyVideo} durationInFrames={120} compositionWidth={1920} compositionHeight={1080} fps={30} controls />;
};
```
...
export const App: React.FC = () => {
  return <Player component={MyVideo} durationInFrames={120} compositionWidth={1920} compositionHeight={1080} fps={30} controls loop />;
};
```
...
export const App: React.FC = () => {
  ...
  return <Player component={MyVideo} durationInFrames={120} compositionWidth={1920} compositionHeight={1080} fps={30} inputProps={inputProps} />;
};
```
...
export const App: React.FC = () => {
  return <Player component={MyVideo} durationInFrames={120} compositionWidth={1920} compositionHeight={1080} fps={30} loop inFrame={30} outFrame={60} />;
};
```
...
export const App: React.FC = () => {
  ...
  return <Player lazyComponent={lazyComponent} durationInFrames={120} compositionWidth={1920} compositionHeight={1080} fps={30} loop />;
};
```
