...
export const getCompositionMenuItems = ({
	...
	return [
			...
			: null,
		{
			...
			quickSwitcherLabel: `Composition: Rename ${composition.id}`,
			subMenu: null,
			type: 'item' as const,
			value: 'rename',
		},
		{
			...
			quickSwitcherLabel: `Composition: Duplicate ${composition.id}`,
			subMenu: null,
			type: 'item' as const,
			value: 'duplicate',
		},
		{
			...
			quickSwitcherLabel: `Composition: Delete ${composition.id}`,
			subMenu: null,
			type: 'item' as const,
			value: 'delete',
		},
		...
		},
		{
			...
			quickSwitcherLabel: `Composition: Copy ID ${composition.id}`,
			subMenu: null,
			type: 'item' as const,
			value: 'copy-id',
		},
