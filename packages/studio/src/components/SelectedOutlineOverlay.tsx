...
export const getSelectedOutlineRotationCornerInfo = (
	...
	return {
		center: getOutlineCenter(points),
		cursor: rotationCursors[corner],
		point,
	};
};
