...
export const AnimationPlayer: React.FC<AnimationPlayerProps> = ({
  ...
  if (isCompiling) {
    return (
      <div className="flex-1 flex flex-col justify-center items-center p-6 bg-[#0a0a0a] min-w-0">
        <div className="w-full max-w-[800px] aspect-video flex justify-center items-center bg-[#1a1a1a] rounded-lg">
  ...
  if (error) {
    return (
      <div className="flex-1 flex flex-col justify-center items-center p-6 bg-[#0a0a0a] min-w-0">
        <div className="w-full max-w-[800px] p-6 bg-[#2a1a1a] rounded-lg border border-[#dc2626]">
  ...
  if (!Component) {
    return (
      <div className="flex-1 flex flex-col justify-center items-center p-6 bg-[#0a0a0a] min-w-0">
        <div className="w-full max-w-[800px] aspect-video flex justify-center items-center bg-[#1a1a1a] rounded-lg text-[#666] text-lg font-sans">
