import {filmBurn, linearTiming, TransitionSeries} from '@remotion/transitions';
...
export const FilmBurnTransitionDoc: React.FC = () => {
	return (
...
export const FilmBurnTransitionDocThumb: React.FC = () => {
	return (
		<AbsoluteFill style={{containerType: 'size'}}>
			<TransitionSeries>
