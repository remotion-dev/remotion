...
const vShaderFullViewport = ShaderLib.basic.vertexShader
...
${ShaderLib.basic.fragmentShader}`
	.replace('#include <map_fragment>', '#include <swirl_map_fragment>');
		...
		>
			...
			{videoTexture && (
				<texturedShaderMaterial
					vertexShader={fullViewport ? vShaderFullViewport : ShaderLib.basic.vertexShader}
					fragmentShader={swirlFragmentShader}
					uniforms={swirlShaderUniforms}
					uniforms-offset-value={[Math.sin(frame * 0.1) * 300, Math.cos(frame * 0.1) * 300]}
