...
bunx remotion lambda render testbed-v6 longVideo --log=verbose --delete-after="1-day" --api-key=rm_pub_9a996d341238eaa34e696b099968d8510420b9f6ba4aa0ee --frames-per-lambda=20
