...
const MAIN_JS = path.join(__dirname, "src/main.ts");
...
fs.writeFileSync(INDEX_MODULE_TS, helpersContent + "\n" + mainJsContent, "utf8");

console.log("✅ Emptied index.module.ts and concatenated helpers.ts and main.ts into it.");
