...
export const rippleShader = (
...
): ReturnType<HtmlInCanvasShader<RippleProps>> => {
	...
	const cleanup: ReturnType<
		HtmlInCanvasShader<RippleProps>
	>['cleanup'] = () => {
		gl.deleteProgram(program);
	...
	const clear: ReturnType<HtmlInCanvasShader<RippleProps>>['clear'] = () => {
		gl.clearColor(0, 0, 0, 0);
		gl.clear(gl.COLOR_BUFFER_BIT);
	};

	const draw: ReturnType<HtmlInCanvasShader<RippleProps>>['draw'] = ({
		prevImage,
		nextImage,
		width,
		height,
...
export const ripple = makeHtmlInCanvasPresentation(rippleShader);
