import { Codec, CodecOrUndefined, validCodecs } from '../codec';

export function validateDefaultCodec(defaultCodec: unknown, location: string): asserts defaultCodec is CodecOrUndefined {
