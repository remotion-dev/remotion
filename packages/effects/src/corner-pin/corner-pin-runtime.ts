...
import {CORNER_PIN_FS, CORNER_PIN_VS} from './corner-pin-shaders.js';
...
export const cleanupCornerPin = (state: CornerPinState): void => {
...
const drawFullscreenQuad = (state: CornerPinState): void => {
	const {gl, vao} = state;
	gl.bindVertexArray(vao);
