...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				devanagari:
					'https://fonts.gstatic.com/s/jaldi/v12/or3sQ67z0_CI33NSbJHPBw.woff2',
				'latin-ext':
			...
			'700': {
				devanagari:
					'https://fonts.gstatic.com/s/jaldi/v12/or3hQ67z0_CI33voSYTxJrUFng.woff2',
				'latin-ext':
...
export const fontFamily = 'Jaldi' as const;
