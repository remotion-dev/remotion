...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				math: 'https://fonts.gstatic.com/s/alikeangular/v26/3qTrojWunjGQtEBlIcwMbSoI7jgwbS7F.woff2',
				symbols:
					'https://fonts.gstatic.com/s/alikeangular/v26/3qTrojWunjGQtEBlIcwMbSoI7iowbS7F.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/alikeangular/v26/3qTrojWunjGQtEBlIcwMbSoI7kowbS7F.woff2',
				latin:
					'https://fonts.gstatic.com/s/alikeangular/v26/3qTrojWunjGQtEBlIcwMbSoI7kQwbQ.woff2',
			},
		},
	},
...
export const fontFamily = 'Alike Angular' as const;
