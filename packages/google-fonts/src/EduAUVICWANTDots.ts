...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				'latin-ext':
					'https://fonts.gstatic.com/s/eduauvicwantdots/v1/S6ujw5FFVDKI3kwwDUbsPHCpzZNhzrA3or3VBa-oAFU.woff2',
				latin:
					'https://fonts.gstatic.com/s/eduauvicwantdots/v1/S6ujw5FFVDKI3kwwDUbsPHCpzZNhzrA3or3VC6-o.woff2',
			},
			'500': {
				'latin-ext':
					'https://fonts.gstatic.com/s/eduauvicwantdots/v1/S6ujw5FFVDKI3kwwDUbsPHCpzZNhzrA3or3VBa-oAFU.woff2',
