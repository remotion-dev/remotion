...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				khmer:
					'https://fonts.gstatic.com/s/preahvihear/v30/6NUS8F-dNQeEYhzj7uluxvwI6dB5fw.woff2',
				latin:
					'https://fonts.gstatic.com/s/preahvihear/v30/6NUS8F-dNQeEYhzj7uluxvwD6dA.woff2',
			},
		},
	},
});
