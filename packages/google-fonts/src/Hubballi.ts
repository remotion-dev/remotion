...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				kannada:
					'https://fonts.gstatic.com/s/hubballi/v7/o-0JIpUj3WIZ1RFN55BmwhF9Yg.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/hubballi/v7/o-0JIpUj3WIZ1RFN55BywhF9Yg.woff2',
				latin:
					'https://fonts.gstatic.com/s/hubballi/v7/o-0JIpUj3WIZ1RFN55B8whE.woff2',
			},
		},
	},
});
