...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				khmer:
					'https://fonts.gstatic.com/s/odormeanchey/v27/raxkHiKDttkTe1aOGcJMR1A_4lrU0TukKQ.woff2',
				latin:
					'https://fonts.gstatic.com/s/odormeanchey/v27/raxkHiKDttkTe1aOGcJMR1A_4lrf0Ts.woff2',
			},
		},
	},
});
