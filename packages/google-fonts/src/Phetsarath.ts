...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				lao: 'https://fonts.gstatic.com/s/phetsarath/v2/N0bQ2SpTP-plK0uWayAYMdD3nA.woff2',
			},
			'700': {
				lao: 'https://fonts.gstatic.com/s/phetsarath/v2/N0bT2SpTP-plK0uWayAYOWLSidnxZA.woff2',
			},
		},
	},
	subsets: ['lao'],
