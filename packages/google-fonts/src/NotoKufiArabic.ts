...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'100': {
				arabic:
					'https://fonts.gstatic.com/s/notokufiarabic/v24/CSRk4ydQnPyaDxEXLFF6LZVLKrodrOYFFlKp.woff2',
				math: 'https://fonts.gstatic.com/s/notokufiarabic/v24/CSRk4ydQnPyaDxEXLFF6LZVLKrodrJ8FFlKp.woff2',
				symbols:
					'https://fonts.gstatic.com/s/notokufiarabic/v24/CSRk4ydQnPyaDxEXLFF6LZVLKrodrI0FFlKp.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/notokufiarabic/v24/CSRk4ydQnPyaDxEXLFF6LZVLKrodrO0FFlKp.woff2',
				latin:
					'https://fonts.gstatic.com/s/notokufiarabic/v24/CSRk4ydQnPyaDxEXLFF6LZVLKrodrOMFFg.woff2',
			},
			'200': {
				arabic:
					'https://fonts.gstatic.com/s/notokufiarabic/v24/CSRk4ydQnPyaDxEXLFF6LZVLKrodrOYFFlKp.woff2',
