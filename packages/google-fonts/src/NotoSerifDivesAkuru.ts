...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				'dives-akuru':
					'https://fonts.gstatic.com/s/notoserifdivesakuru/v2/QldfNSVMqAsHtsJ_TnD3aT03sMgd57ibeeZT2-vj7ohECw.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/notoserifdivesakuru/v2/QldfNSVMqAsHtsJ_TnD3aT03sMgd57ibeeZT20nCy7V9.woff2',
				latin:
					'https://fonts.gstatic.com/s/notoserifdivesakuru/v2/QldfNSVMqAsHtsJ_TnD3aT03sMgd57ibeeZT20fCyw.woff2',
			},
		},
	},
