	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/madimione/v1/2V0YKIEADpA8U6RygDnZVD0iB7HM.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/madimione/v1/2V0YKIEADpA8U6RygDnZVF0iB7HM.woff2',
				latin:
...
export const fontFamily = 'Madimi One' as const;
