...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				'cyrillic-ext':
					'https://fonts.gstatic.com/s/rubiklines/v1/_gP81R3vsjYzVW2Y6xFF-FS7avtLoQ.woff2',
				cyrillic:
					'https://fonts.gstatic.com/s/rubiklines/v1/_gP81R3vsjYzVW2Y6xFF-FSyavtLoQ.woff2',
				hebrew:
					'https://fonts.gstatic.com/s/rubiklines/v1/_gP81R3vsjYzVW2Y6xFF-FS0avtLoQ.woff2',
				math: 'https://fonts.gstatic.com/s/rubiklines/v1/_gP81R3vsjYzVW2Y6xFF-FTKavtLoQ.woff2',
				symbols:
					'https://fonts.gstatic.com/s/rubiklines/v1/_gP81R3vsjYzVW2Y6xFF-FTYavtLoQ.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/rubiklines/v1/_gP81R3vsjYzVW2Y6xFF-FS4avtLoQ.woff2',
				latin:
					'https://fonts.gstatic.com/s/rubiklines/v1/_gP81R3vsjYzVW2Y6xFF-FS2avs.woff2',
			},
		},
	},
	subsets: [
...
export const fontFamily = 'Rubik Lines' as const;
