...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				'cyrillic-ext':
					'https://fonts.gstatic.com/s/yesevaone/v22/OpNJno4ck8vc-xYpwWWxliBVWyXD.woff2',
				cyrillic:
					'https://fonts.gstatic.com/s/yesevaone/v22/OpNJno4ck8vc-xYpwWWxlilVWyXD.woff2',
				vietnamese:
...
export const fontFamily = 'Yeseva One' as const;
