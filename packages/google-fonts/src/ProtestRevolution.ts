	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/protestrevolution/v2/11hcGofZ0kXBbxQXFB7MJsjtqnVw6Z2cmfgyfG0.woff2',
				vietnamese:
					'https://fonts.gstatic.com/s/protestrevolution/v2/11hcGofZ0kXBbxQXFB7MJsjtqnVw6Z2c-PgyfG0.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/protestrevolution/v2/11hcGofZ0kXBbxQXFB7MJsjtqnVw6Z2c-fgyfG0.woff2',
				latin:
...
export const fontFamily = 'Protest Revolution' as const;
