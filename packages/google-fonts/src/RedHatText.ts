...
export const getInfo = () => ({
	...
	fonts: {
		italic: {
			'300': {
				'latin-ext':
					'https://fonts.gstatic.com/s/redhattext/v14/RrQJbohi_ic6B3yVSzGBrMxQbZchO8i5PA.woff2',
				latin:
					'https://fonts.gstatic.com/s/redhattext/v14/RrQJbohi_ic6B3yVSzGBrMxQbZcvO8g.woff2',
			},
			'400': {
				'latin-ext':
					'https://fonts.gstatic.com/s/redhattext/v14/RrQJbohi_ic6B3yVSzGBrMxQbZchO8i5PA.woff2',
		...
		normal: {
			'300': {
				'latin-ext':
					'https://fonts.gstatic.com/s/redhattext/v14/RrQXbohi_ic6B3yVSzGBrMxQZqctI8w.woff2',
				latin:
