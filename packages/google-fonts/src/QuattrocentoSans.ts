...
export const getInfo = () => ({
	...
	fonts: {
		italic: {
			'400': {
				'latin-ext':
					'https://fonts.gstatic.com/s/quattrocentosans/v18/va9a4lja2NVIDdIAAoMR5MfuElaRB0zMh0P2GEHJ.woff2',
				latin:
					'https://fonts.gstatic.com/s/quattrocentosans/v18/va9a4lja2NVIDdIAAoMR5MfuElaRB0zMh032GA.woff2',
			},
			'700': {
				'latin-ext':
					'https://fonts.gstatic.com/s/quattrocentosans/v18/va9X4lja2NVIDdIAAoMR5MfuElaRB0zMj_bTDXDojYsJ.woff2',
				latin:
					'https://fonts.gstatic.com/s/quattrocentosans/v18/va9X4lja2NVIDdIAAoMR5MfuElaRB0zMj_bTDX7ojQ.woff2',
			},
		},
		normal: {
			'400': {
			...
			'700': {
				'latin-ext':
					'https://fonts.gstatic.com/s/quattrocentosans/v18/va9Z4lja2NVIDdIAAoMR5MfuElaRB0RyklrfPXzwiQ.woff2',
				latin:
...
export const fontFamily = 'Quattrocento Sans' as const;
