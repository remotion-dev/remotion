	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/yarndings12charted/v3/eLGDP_DlKhO-DUfeqM4I_vDdJgmIh7hAvsag2N6tHQ.woff2',
				latin:
					'https://fonts.gstatic.com/s/yarndings12charted/v3/eLGDP_DlKhO-DUfeqM4I_vDdJgmIh7hAvsbO2N4.woff2',
			},
		},
	},
});

export const fontFamily = 'Yarndings OneTwo Charted' as const;
