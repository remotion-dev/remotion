	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/protestguerrilla/v2/Qw3HZR5PDSL6K3irtrY-VJB2YzARHW1Nqp4C_Q.woff2',
				vietnamese:
					'https://fonts.gstatic.com/s/protestguerrilla/v2/Qw3HZR5PDSL6K3irtrY-VJB2YzARHW0sqp4C_Q.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/protestguerrilla/v2/Qw3HZR5PDSL6K3irtrY-VJB2YzARHW0tqp4C_Q.woff2',
				latin:
...
export const fontFamily = 'Protest Guerrilla' as const;
