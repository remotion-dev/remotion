...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				bengali:
					'https://fonts.gstatic.com/s/mina/v11/-nFzOGc18vARnypp7x3y.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/mina/v11/-nFzOGc18vARnzZp7x3y.woff2',
				latin: 'https://fonts.gstatic.com/s/mina/v11/-nFzOGc18vARnzhp7w.woff2',
			},
			'700': {
				bengali:
					'https://fonts.gstatic.com/s/mina/v11/-nF8OGc18vARl4NM-jDT9qOk.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/mina/v11/-nF8OGc18vARl4NM-izT9qOk.woff2',
				latin:
					'https://fonts.gstatic.com/s/mina/v11/-nF8OGc18vARl4NM-iLT9g.woff2',
			},
		},
	},
});
