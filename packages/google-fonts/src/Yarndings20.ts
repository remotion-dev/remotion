	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/yarndings20/v4/TuGWUVlkUohEQu8l7K8b-vN1bnU1DMQ.woff2',
				latin:
					'https://fonts.gstatic.com/s/yarndings20/v4/TuGWUVlkUohEQu8l7K8b-vN1AHU1.woff2',
			},
		},
	},
...
export const fontFamily = 'Yarndings TwoZero' as const;
