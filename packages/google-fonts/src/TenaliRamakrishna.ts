...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				telugu:
					'https://fonts.gstatic.com/s/tenaliramakrishna/v12/raxgHj6Yt9gAN3LLKs0BZVMo8jmwn1-MM5_rYFE.woff2',
				latin:
					'https://fonts.gstatic.com/s/tenaliramakrishna/v12/raxgHj6Yt9gAN3LLKs0BZVMo8jmwn1-ML5_r.woff2',
			},
		},
	},
});
