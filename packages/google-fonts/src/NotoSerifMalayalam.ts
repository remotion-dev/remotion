...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'100': {
				malayalam:
					'https://fonts.gstatic.com/s/notoserifmalayalam/v28/JIAsUU5sdmdP_HMcVcZFcH7DeVBeGVgSMGMiWpSrNw.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/notoserifmalayalam/v28/JIAsUU5sdmdP_HMcVcZFcH7DeVBeGVgSMGM0WpSrNw.woff2',
				latin:
					'https://fonts.gstatic.com/s/notoserifmalayalam/v28/JIAsUU5sdmdP_HMcVcZFcH7DeVBeGVgSMGM6WpQ.woff2',
			},
			'200': {
				malayalam:
					'https://fonts.gstatic.com/s/notoserifmalayalam/v28/JIAsUU5sdmdP_HMcVcZFcH7DeVBeGVgSMGMiWpSrNw.woff2',
