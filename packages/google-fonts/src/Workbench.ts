...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				math: 'https://fonts.gstatic.com/s/workbench/v2/FeV8S05Gp6Et7FcfbPFK1rynGd_MxtkvNFmoUDFhgF2VKTGQk6vapePw2mOagQ.woff2',
				symbols:
					'https://fonts.gstatic.com/s/workbench/v2/FeV8S05Gp6Et7FcfbPFK1rynGd_MxtkvNFmoUDFhgF2VKTGQk6vapePi2mOagQ.woff2',
				latin:
					'https://fonts.gstatic.com/s/workbench/v2/FeV8S05Gp6Et7FcfbPFK1rynGd_MxtkvNFmoUDFhgF2VKTGQk6vapeOM2mM.woff2',
			},
		},
	},
...
export const fontFamily = 'Workbench' as const;
