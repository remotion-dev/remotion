...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				devanagari:
					'https://fonts.gstatic.com/s/eczar/v22/BXRlvF3Pi-DLmz0kDO5C8A.woff2',
				'greek-ext':
					'https://fonts.gstatic.com/s/eczar/v22/BXRlvF3Pi-DLmz0pDO5C8A.woff2',
				greek:
					'https://fonts.gstatic.com/s/eczar/v22/BXRlvF3Pi-DLmz0mDO5C8A.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/eczar/v22/BXRlvF3Pi-DLmz0rDO5C8A.woff2',
				latin:
