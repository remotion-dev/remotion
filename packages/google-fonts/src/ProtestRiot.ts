	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr8vvhhvmQ.woff2',
				vietnamese:
					'https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr83_hhvmQ.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr83vhhvmQ.woff2',
				latin:
					'https://fonts.gstatic.com/s/protestriot/v2/d6lPkaOxWMKm7TdezXFmpkr80Phh.woff2',
			},
		},
	},
...
export const fontFamily = 'Protest Riot' as const;
