...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				'cyrillic-ext':
					'https://fonts.gstatic.com/s/rubikmaps/v1/Gw6_wcjl80TZK9XxtbbevSweCyRq.woff2',
				cyrillic:
					'https://fonts.gstatic.com/s/rubikmaps/v1/Gw6_wcjl80TZK9XxtbbevSUeCyRq.woff2',
				hebrew:
					'https://fonts.gstatic.com/s/rubikmaps/v1/Gw6_wcjl80TZK9XxtbbevSMeCyRq.woff2',
				math: 'https://fonts.gstatic.com/s/rubikmaps/v1/Gw6_wcjl80TZK9XxtbbevV0eCyRq.woff2',
				symbols:
					'https://fonts.gstatic.com/s/rubikmaps/v1/Gw6_wcjl80TZK9XxtbbevU8eCyRq.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/rubikmaps/v1/Gw6_wcjl80TZK9XxtbbevS8eCyRq.woff2',
				latin:
					'https://fonts.gstatic.com/s/rubikmaps/v1/Gw6_wcjl80TZK9XxtbbevSEeCw.woff2',
			},
		},
	},
	subsets: [
...
export const fontFamily = 'Rubik Maps' as const;
