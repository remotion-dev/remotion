	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/jacquardabastarda9/v5/f0Xp0fWr_8t6WFtKQJfOhaC0hcZ1HYAMAYxq3zFPJA.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/jacquardabastarda9/v5/f0Xp0fWr_8t6WFtKQJfOhaC0hcZ1HYAMAYwK3zFPJA.woff2',
				latin:
					'https://fonts.gstatic.com/s/jacquardabastarda9/v5/f0Xp0fWr_8t6WFtKQJfOhaC0hcZ1HYAMAYwE3zE.woff2',
			},
		},
	},
...
export const fontFamily = 'Jacquarda Bastarda Nine' as const;
