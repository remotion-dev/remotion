...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				'tai-le':
					'https://fonts.gstatic.com/s/notosanstaile/v17/vEFK2-VODB8RrNDvZSUmVxEATwR5wpm_Wo7H.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/notosanstaile/v17/vEFK2-VODB8RrNDvZSUmVxEATwR5wtu_Wo7H.woff2',
				latin:
					'https://fonts.gstatic.com/s/notosanstaile/v17/vEFK2-VODB8RrNDvZSUmVxEATwR5wtW_Wg.woff2',
			},
		},
	},
});
