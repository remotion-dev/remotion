	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/alike/v21/HI_EiYEYI6BIoHioQ5TwQw.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/alike/v21/HI_EiYEYI6BIoHjIQ5TwQw.woff2',
				latin:
					'https://fonts.gstatic.com/s/alike/v21/HI_EiYEYI6BIoHjGQ5Q.woff2',
			},
		},
	},
});

export const fontFamily = 'Alike' as const;
