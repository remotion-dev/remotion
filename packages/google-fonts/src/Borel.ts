	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/borel/v10/6qLOKZsftAPisjtIaSIXOg.woff2',
				vietnamese:
					'https://fonts.gstatic.com/s/borel/v10/6qLOKZsftAPisjspaSIXOg.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/borel/v10/6qLOKZsftAPisjsoaSIXOg.woff2',
				latin:
					'https://fonts.gstatic.com/s/borel/v10/6qLOKZsftAPisjsmaSI.woff2',
			},
		},
	},
