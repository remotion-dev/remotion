...
export const getInfo = () => ({
	...
	fonts: {
		italic: {
			'100': {
				vietnamese:
					'https://fonts.gstatic.com/s/librefranklin/v14/jizBREVItHgc8qDIbSTKq4XkRiUa6zoTjmbI.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/librefranklin/v14/jizBREVItHgc8qDIbSTKq4XkRiUa6zsTjmbI.woff2',
				latin:
