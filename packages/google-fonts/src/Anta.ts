	...
	fonts: {
		normal: {
			'400': {
				...
				symbols:
					'https://fonts.gstatic.com/s/anta/v1/gyBzhwQ3KsIyVDU7PWim.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/anta/v1/gyBzhwQ3KsIyVFU7PWim.woff2',
...
export const fontFamily = 'Anta' as const;
