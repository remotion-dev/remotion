...
export const getInfo = () => ({
	...
	fonts: {
		normal: {
			'400': {
				devanagari:
					'https://fonts.gstatic.com/s/yatraone/v14/C8ch4copsHzj8p7NaF0BxVmAXRA.woff2',
				'latin-ext':
					'https://fonts.gstatic.com/s/yatraone/v14/C8ch4copsHzj8p7NaF0BylmAXRA.woff2',
				latin:
...
export const fontFamily = 'Yatra One' as const;
