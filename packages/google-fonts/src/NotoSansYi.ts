	...
	fonts: {
		normal: {
			'400': {
				...
				'latin-ext':
					'https://fonts.gstatic.com/s/notosansyi/v19/sJoD3LFXjsSdcnzn071rO3aZzFrIBVg.woff2',
				latin:
					'https://fonts.gstatic.com/s/notosansyi/v19/sJoD3LFXjsSdcnzn071rO3aZwlrI.woff2',
			},
		},
	},
});
