...
test('Should be able to track production usage', async () => {
	const result = await registerUsageEvent({
		licenseKey: 'rm_pub_cbbf1d1e7f07cb0b86daa0247693d6c9af4740463768f2f6',
...
test('should require secret key for usage', () => {
	const result = getUsage({
		licenseKey: 'rm_pub_1dd7193534bbe72571b55bd43926654ddaaca3dd6f07772b',
		since: null,
	});
...
test('should be able to get usage', async () => {
	const result = await getUsage({
		licenseKey: 'rm_sec_b776a51f683c850101ece5c580c7db7281397d1864e076a9',
		since: null,
	});
...
test('should not be able to get usage older than 90 says', () => {
	const result = getUsage({
		licenseKey: 'rm_sec_7cef7338672c2b474729ac081134a6ded7dc360baf0068fe',
