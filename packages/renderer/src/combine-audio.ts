...
const durationOf1Frame = (1024 / DEFAULT_SAMPLE_RATE) * 1_000_000;

const getClosestAlignedTime = (targetTime: number) => {
...
const combineAudioSeamlessly = async ({
	...
	const fileList = files
		.map((p, i) => {
			...
			const outpoint = realDuration + inpoint - durationOf1Frame;
