	...
	return (
		<Page className="flex-col">
			<div className="m-auto max-w-[1200px] w-full px-4 py-12">
				<div className="mb-8">
					<h1 className="text-3xl font-brand font-black">Prompt Gallery</h1>
					<p className="font-brand text-muted-foreground mt-4 max-w-[700px]">
						With{' '}
						<a href="/docs/ai/skills" className="underline hover:text-black">
							Remotion Skills
						</a>
				...
				<a href="/prompts/submit" className="flex items-center gap-2">
					<Button className="font-brand rounded-full bg-[#D97757] flex items-center text-white">
						...
						<div className="text-sm">Make your own</div>
					</Button>
