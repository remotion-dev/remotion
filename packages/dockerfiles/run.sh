...
docker build --file Dockerfile.ubuntu24 . --output type=tar,dest=/dev/null --progress=plain
docker build --file Dockerfile.ubuntu22 . --output type=tar,dest=/dev/null --progress=plain
