...
const accessibilityLabel = 'Editor Zoom Gestures';

export const EditorZoomGesturesToggle: React.FC = () => {
	const {editorZoomGestures, setEditorZoomGestures} = useContext(
		EditorZoomGesturesContext
	);

	const onClick = useCallback(() => {
		setEditorZoomGestures((c) => {
			return !c;
		});
	...
	return (
		...
		>
			...
			>
				<path
					fill={editorZoomGestures ? 'var(--blue)' : 'white'}
