...
test('Should be able to make a pentagon', () => {
	...
	expect(container.querySelector('path')?.getAttribute('d')).toEqual(
		'M 95.10565162951536 0 L 190.21130325903073 69.09830056250526 L 153.8841768587627 180.90169943749476 L 36.327126400268064 180.90169943749476 L 0 69.09830056250527 L 95.10565162951536 0',
	);
});
