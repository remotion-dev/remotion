...
test.each([
	{effectsOutputSize: {width: 320, height: 180}, width: 320, height: 180},
	{effectsOutputSize: undefined, width: 1280, height: 720},
])(
	'applies effects at $width × $height in preview',
	async ({effectsOutputSize, width, height}) => {
