...
Update `packages/skills/skills/remotion-best-practices/SKILL.md`:
...
Do not duplicate the full list in `packages/skills/skills/remotion-best-practices/rules/effects.md`; keep that rule limited to general usage mechanics unless the new effect changes import or installation conventions.
...
- Do not forget to update the top-level available effects list in `packages/skills/skills/remotion-best-practices/SKILL.md`.
