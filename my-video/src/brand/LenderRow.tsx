...
// card (St.George's file has a white background; NAB and Bankwest are their
// own dark versions, so they show as dark tiles). Keep `height` at 100 or
// less: firstmac.png is only 102px tall. `scale` evens out the logos' shapes.
