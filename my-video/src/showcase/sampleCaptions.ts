...
//
// The space goes BEFORE each word, as Whisper emits it: createTikTokStyleCaptions()
// only starts a new page at a token that begins with a space, so trailing
// spaces silently merged the whole transcript into one page. The 140ms gap
// after "Remotion:" is a natural pause for breakOnSilenceAfterMilliseconds.
export const sampleCaptions: Caption[] = [
  ...
  {text: " videos", startMs: 900, endMs: 1000, timestampMs: null, confidence: null},
